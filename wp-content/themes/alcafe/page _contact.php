...
<?php get_header() ?>
	...
	<div id="contact_summary">
					<p style="text-align: justify;">Alzheimer Café se koná v Centru Seňorina. Tento denní stacionář se nachází v 1. patře domu Na Poříčí 36, v Praze 1<strong>,</strong> s výbornou dostupností MHD (metro B a C, BUS, TRAM, vlakové Masarykovo nádraží). Přístup do centra je bezbariérový, v domě je výtah.</p>
